...
export function InteractiveBadge({ id, content, title = "Physics Model Analysis", fullContext, settings, existingAnalysis, onAnalysisComplete }: InteractiveBadgeProps) {
  ...
  // Cache fetchAnalysis function to avoid re-creation on every render
  const fetchAnalysis = useCallback(async () => {
    ...
    setIsLoading(true);
    try {
        const body: AnalyzeRequestBody = { context: content, fullContext: fullContext };
  ...
  }, [content, fullContext, id, onAnalysisComplete, settings]);
  ...
  }, [isOpen, analysis, isLoading, fetchAnalysis, buttonRef]);
